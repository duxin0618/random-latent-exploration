...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default=os.path.basename(__file__).rstrip(".py"), #删除字符串末尾的".py"字符
    ...
    parser.add_argument("--gamma", type=float, default=0.999,   # 环境给与的奖励的折扣因子
